...
class NIBBSController extends Controller
{
    ...
    {
        return hash('sha256', 'NIBSS0000000128033codergab@gmail.comGOENERGEE POSTPAID PAYMENT5000566FHFKDHI43JK43434JJLJLJhttp://localhost:8000/nibbs/callbackF78BE99289AB52FDF97190CEBFC1D6B8');
        return [
            [
                "bankCode" => "214",
