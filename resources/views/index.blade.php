...
<head>
	...
	<meta name="csrf-token" content="{{ csrf_token() }}" <link href="/images/favicon.png" rel="shortcut icon" type="image/png">
						...
						<div class="row">
							...
							<div class="col-md-7 col-sm-12 col-xs-12" style="padding:3px">
								...
								<div id="news">
									<div class="text-insert" style="margin-bottom:10px;">
										...
										<p style="margin-top:7px;">
											<span style="color:#a9191e;">
												<a href="https://www.goenergee.com/support.html">Click on Support for assistance!</span>
										</p>
										</a>
									</div>
								...
								<div class="user-details" id="login" style="">
									<div style="">
										...
										<p style="text-align:center; margin-top:-5px;">
											<a class="btn btn-primary social-login-btn " href="/auth/facebook" style="background-color:#3d578e;">
												<i class="fab fa-facebook-f"></i>
											</a>
											<a class="btn btn-primary social-login-btn " href="/auth/twitter" style="background-color:#28a9e0;">
												<i class="fab fa-twitter"></i>
											</a>
											<a class="btn btn-primary social-login-btn " href="/auth/linkedin" style="background-color:#0b78b6;">
												<i class="fab fa-linkedin-in"></i>
											</a>
											<a class="btn btn-primary social-login-btn " href="/auth/google" style="background-color:#d52727;">
								...
								<div id="make_payments" style="">
									...
									<a href="/postpaidpayment" target="_blank">
