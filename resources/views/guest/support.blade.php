	...
	<div class="container">
		...
		<ul class="nav-ul">
			...
			<li class="nav-item item">
				...
				<a class="nav-link disabled" href="{{ route('guest.login') }}">Sign In</a>
			</li>
			<li class="nav-item item">
		...
		<div class="row">
			<div class="col-md-7 col-sm-12 col-xs-12" style="z-index:20;">
				...
				<div class="row">
					...
					<!--col-6 ends -->
					<!--
						<div class="col-md-4 support" style=" padding:3px;">
			<div id="support">
				...
				<h5>
					...
					<!--new col7 starts here temp change-->
					<div class="col-md-7 col-sm-12 col-xs-12" style="padding:3px">
						...
						<div class="user-details" id="login" style="border-radius:3%;padding:10px 20px;">
							<div style="">
								...
								<h4 style="color:#80c636">
									<b>
										<div class="text-center login-title">Customer Support Service
									</b>
								</h4>
								<h5 style="color:#80c636">
									<b>Head Office</b>
								...
								<br><br><br><br><br><br><br><br><br><br>
									...
									<h5>
										<b>Company name:</b> Spec Engineering Services</h5>
										
									<h5>
										<b>Contact Address:</b> 10 Aina Street, Badore, Ajah, Lagos</h5>
									<h5>
			...
			if ($("#searchForm").val() !== '') {
				...
				if (navigator.onLine) {
					fetch(`/lists/services/${value}`)
						...
						.catch(err => {
							$(".services-list-overlay").html(
								'<center><span style="color: red;">Something bad went wrong, Try Again Later.</span></center>');
						});
				} else {
					$(".services-list-overlay").html(
						'<center><span style="color: red;">Oops! Seems you are disconnected.</span></center>');
				}
