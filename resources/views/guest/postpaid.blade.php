...
<html class="no-js">
	...
	<head>
		<title>PostPaid Payments - GOENERGEE</title>
		<meta charset="utf-8">
									...
									<div class="row">
										<div class="col-md-12">
											<div class="form-group">
												...
												@auth
												<input type="text" name="meter_no" class="meterno form-control" value="{{ auth()->user() }}">
												@endauth
												@guest
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input id="reconnectionPaymentInput" placeholder="0.00" class="amount form-control" name="reconnection"
												 type="number" disabled="disabled" onkeyup="calculate()" />
											</div>
										</div>
										<div class="col-md-6">
											<div class="form-group">
										...
										<div class="col-md-6">
											<div class="form-group">
												...
												<input type="text" name="conv_fee" value="100.00" id="conv_fee" onkeyup="calculate()" class="form-control"
												 readonly>
											</div>
										</div>
										<div class="col-md-6">
