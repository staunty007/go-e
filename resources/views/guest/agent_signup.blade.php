	...
	<div class="container">
		...
		<div class="row">
			...
			<div class="col-xs-4 col-md-2">
				...
				<a href="{{ route('guest.become_agent') }}"><button type="button" class="grad-box" id="support_btn" style="padding:50px 32px">
						<i class="fas fa-question-circle"></i>
						Why be an Agent
					</button></a>
			
                    <a href="{{ route('guest.agent_signup') }}"><button type="button" id="payment_btn" style=" background-color: #fff !important; padding:30px 31px; color: #8CC74E;"
                        class="grad-boxa">
