...
<head>
    <title>AGENT SIGN UP FORM :::GOENERGEE</title>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div class="row">
        ...
        <div class="col-xs-4 col-md-2">
            ...
            <a href="{{ route('guest.become_agent') }}">
            ...
            <a href="{{ route('guest.agent_signup') }}">
                <button type="button" id="payment_btn"
                        style=" background-color: #fff !important; padding:30px 31px; color: #8CC74E;"
                        class="grad-boxa">
            ...
            <a href="{{ route('guest.agent_benefit') }}">
                <button type="button" class="grad-box" id="support_btn" style="padding:50px 32px">
        ...
        <div class="col-xs-8 col-md-10" style="padding:0px 0px;">
            <div class="user-details" id="login1" style="border-radius:3%">
                <div style="padding:10px 30px;">
                    ...
                    <form action="{{ route('guest.agent_signup-store') }}" method="POST">
                        {{ csrf_field() }}
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="name" id="name" class="input-sm" placeholder="E.g John Doe"
                                       value="{{ old('name') }}">
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="company_name" id="company" class=" input-sm" placeholder=""
                        ...
                        <div class="col-xs-3 col-sm-3 col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" name="district" id="district" class=" input-sm"
                                       placeholder="E.g Mushin" value="{{ old('district') }}">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="email" name="email" id="email" class="form-control danger" placeholder=""
                                       value="{{ old('email') }}">
                                @if($errors->has('email'))
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="address" id="address" class="form-control"
                                       placeholder="Full Business Address" value="{{ old('address') }}">
                            </div>
                        </div>
