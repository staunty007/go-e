    ...
    <div class="col-lg-4">
        <div class="stat">
            <div class="stat__icon-wrapper stat--bg-green">
                <i data-feather="tablet" class="stat__icon"></i>
            </div>
            <div class="stat__data">
                <h1 class="stat__header">Wallet Balance</h1>
                <p class="stat__subheader"><span>&#8358;</span>{{ number_format($balance) }}</p>
            </div>
        </div>
</div>
<div class="col-lg-4">
        <div class="stat stat">
            ...
            <div class="stat__data">
                <h1 class="stat__header">Last Topup Amount</h1>
                <p class="stat__subheader"><span>&#8358;</span>{{ number_format($theLast) }}</p>
            </div>
        </div>
</div>
<div class="col-lg-4">
        <div class="stat">
            <div class="stat__icon-wrapper stat--bg-red">
                <i data-feather="command" class="stat__icon"></i>
            </div>
            <div class="stat__data stat--has-text-right">
                <h1 class="stat__header">Total Year to date Transaction</h1>
                <p class="stat__subheader"><span>&#8358;</span>{{ number_format($allSold) }}</p>
            </div>
        </div>
    </div>
</div>
                        ...
                        <div class="col-sm-2">
                            <div class="form-group">
                                ...
                                <select id="bank" class="form-control">
                                    ...
                                    <option value="Standard Chartered Bank Nigeria Ltd">Standard Chartered Bank Nigeria
                                        Ltd</option>
