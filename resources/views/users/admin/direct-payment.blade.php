    ...
    <div class="col-lg-4 col-md-4">
        ...
        <div class="stat">
            ...
            <div class="stat__data">
                ...
                <small>Prepaid Customers<span class="pull-right">{{ $prepaidCustomers }}</span></small>
                </p>
                <p class="stat__subheader">
                <small>Postpaid Customers<span class="pull-right">{{ $postpaidCustomers }}</span></small>
                </p>
            </div>
        </div>
    </div>
...
<div class="col-lg-14" style="width:100%;margin-top: 20px;">
                        ...
                        <table class="table table-striped table-bordered table-hover dataTables-example">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>₦{{ number_format($p->transaction->net_amount,2) }}</td>
                                    <td>₦{{ number_format($p->transaction->wallet_bal,2) }}</td>
                                </tr>
                                @endforeach
                            </tbody>
                            <tfoot>
...
<script>
    $(document).ready(function () {
        let tabili = $('.dataTables-example').DataTable();
