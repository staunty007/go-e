                                ...
                                <div class="col-lg-9">
                                    ...
                                    <div class="carousel slide" id="carousel2">
                                        ...
                                        <div class="carousel-inner">
                                            ...
                                            <div class="item ">
                                                <img alt="image" class="img-responsive" src="img/7.png">

                                            </div>
                                            <div class="item ">
                                                <img alt="image" class="img-responsive" src="img/8.png">

                                            </div>
                                            <div class="item ">
                                                <img alt="image" class="img-responsive" src="img/9.png">

                                            </div>
                                            <div class="item ">
                                                <img alt="image" class="img-responsive" src="img/10.png">
