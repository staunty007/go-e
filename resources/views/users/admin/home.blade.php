...
<head>
    ...
    <link href="/customer/css/style.css" rel="stylesheet">
     <link href="/customer/css/plugins/dataTables/datatables.min.css" rel="stylesheet">
...
<body>
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
            ...
            <ul class="nav metismenu" id="side-menu">
                ...
                <li class="active">
                    ...
                    <ul class="nav nav-second-level">
                        ...
                        <li class="active"><span>&#8358;</span></i> <span class="nav-label">&nbsp;Financial</span></a>
                        <li><a href="report_agent.html">Agent Report</a></li>
                        <li><a href="customer_report.html">Customer Report</a></li>
                        <li><a href="Payment_history.html">Payment History </a></li>
                    </ul>
                </li>
                <li>
                    <a href="Settings.html"><i class="fa fa-diamond"></i> <span class="nav-label">Settings</span></a>

                </li>
                 <li>
                   <a href="meter_admin.html"><i class="fa fa-table"></i> <span class="nav-label">Meter Administration</span></a>
                </li>
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu dropdown-messages">
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="/customer/img/a7.jpg">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="/customer/img/a4.jpg">
                                </a>
                                <div>
                        ...
                        <li>
                            <div class="dropdown-messages-box">
                                <a href="profile.html" class="pull-left">
                                    <img alt="image" class="img-circle" src="/customer/img/profile.jpg">
                                </a>
                                <div>
        ...
        <div class="footer">
            ...
            <div>
                <strong>Copyright</strong> Spec Engineering &copy; 2018
            </div>
        </div>
        </div>
                    ...
                    <div id="tab-1" class="tab-pane active">
                        ...
                        <div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/customer/img/a1.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/customer/img/a2.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/customer/img/a3.jpg">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/customer/img/a4.jpg">
                                    </div>
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/customer/img/a8.jpg">
                                    </div>
                                    <div class="media-body">
                            ...
                            <div class="sidebar-message">
                                <a href="#">
                                    <div class="pull-left text-center">
                                        <img alt="image" class="img-circle message-avatar" src="/customer/img/a7.jpg">
                                    </div>
                                    <div class="media-body">
